...
import { CheckCircle2, MapPin, BedDouble, ShieldCheck, Wifi, Tv, Wind, Zap } from 'lucide-react';
    ...
    return (
      <div className="w-[220px] overflow-hidden rounded-xl bg-white flex flex-col group shadow-lg">
        ...
        <div className="p-3 flex flex-col gap-1.5">
          ...
          <a href={`/rooms/${room.id}`} className="mt-1 text-center font-semibold text-xs bg-green-50 text-green-700 py-2 rounded-lg hover:bg-green-600 hover:text-white transition-colors">
            View Details
          </a>
        </div>
      </div>
    ...
    <div className="flex flex-col sm:flex-row bg-white rounded-[20px] shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 group relative">
      ...
      <div className="p-5 flex flex-col flex-1 gap-3 justify-between bg-white">
        ...
        <div className="flex items-center justify-between mt-3 pt-4 border-t border-gray-100/80">
          ...
          <a href={`/rooms/${room.id}`} className="text-sm font-bold text-green-600 hover:text-white hover:bg-green-600 px-4 py-2 rounded-xl border-2 border-green-600 transition-all flex items-center gap-1.5 shadow-sm overflow-hidden group/btn">
